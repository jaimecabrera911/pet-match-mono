...
// Function to get initial state from cookie
function getInitialState(): boolean {
  ...
  return true // Default to expanded if no cookie exists
}

// Function to set cookie with proper attributes
function setSidebarCookie(value: boolean) {
  const cookieValue = `${SIDEBAR_COOKIE_NAME}=${value}; max-age=${SIDEBAR_COOKIE_MAX_AGE}; path=/; samesite=strict`
